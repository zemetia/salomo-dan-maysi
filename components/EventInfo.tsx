...
const EventCard: React.FC<{
  ...
  return (
    <div className="mb-24 last:mb-0">
      <Reveal
        direction="up"
        className="bg-white shadow-[0_30px_60px_rgba(0,0,0,0.06)] rounded-[8px] py-16 md:py-24 px-8 md:px-16 border border-[#E6E3DE] relative overflow-hidden max-w-[850px] mx-auto"
      >
      ...
      <Reveal
        direction="up"
        className="flex flex-col md:flex-row gap-8 justify-center mb-16 mt-8"
      >
      ...
      {/* LUXURY ARTISAN MAP INTEGRATION */}
      <Reveal direction="up" className="relative group px-0 md:px-12">
        {/* Gallery Matting Frame */}
        <div className="absolute -inset-2 md:-inset-6 border border-gold/10 rounded-[4px] pointer-events-none transition-all duration-1000 group-hover:border-gold/30"></div>

        {/* Main Canvas Container */}
        <div className="relative w-full aspect-[4/3] md:aspect-[21/9] rounded-[4px] overflow-hidden shadow-[0_40px_100px_rgba(0,0,0,0.12)] bg-[#F2EFE9] border border-[#E6E3DE]">
...
const EventInfo: React.FC<EventInfoProps> = ({ t }) => {
  return (
    <div className="max-w-6xl mx-auto text-center overflow-hidden px-4 md:px-0">
      <EventCard details={t.ceremony} type="ceremony" />
      <div className="my-20">
        <div className="w-[1px] h-24 bg-gradient-to-b from-transparent via-gold to-transparent mx-auto opacity-30"></div>
      </div>
